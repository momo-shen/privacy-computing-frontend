...
import * as Plugin_0 from 'D:/Downloads/privacy-computing-frontend-main/apps/platform/src/app.ts';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/Downloads/privacy-computing-frontend-main/apps/platform/src/app.ts',
    },
    {
      apply: Plugin_1,
