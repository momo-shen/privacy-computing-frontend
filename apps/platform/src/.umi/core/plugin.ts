...
import * as Plugin_0 from 'D:/dev_projects/privacy-computing-frontend/apps/platform/src/app.ts';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : 'D:/dev_projects/privacy-computing-frontend/apps/platform/src/app.ts',
    },
    {
      apply: Plugin_1,
