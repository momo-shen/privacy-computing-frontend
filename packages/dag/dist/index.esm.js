...
import { Badge, Tooltip, Typography as Typography2 } from "antd";
...
var EllipsisMiddles = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    Text,
    {
      ...
      ellipsis: {
        suffix,
        tooltip: showTip ? /* @__PURE__ */ jsx("span", { children }) : null
      },
      children: start
    }
  );
...
var Description = (props) => {
  ...
  return /* @__PURE__ */ jsx2("div", { className: "description", children: /* @__PURE__ */ jsxs("div", { className: "bottom", children: [
    /* @__PURE__ */ jsxs("div", { className: "copy", children: [
      /* @__PURE__ */ jsx2("span", { children: "\u7EC4\u4EF6ID\uFF1A" }),
      /* @__PURE__ */ jsx2("span", { children: /* @__PURE__ */ jsx2(
        Paragraph,
        {
          copyable: {
            text: id,
    ...
    /* @__PURE__ */ jsxs("div", { style: { marginBottom: "4px" }, children: [
      /* @__PURE__ */ jsx2("span", { children: "\u6267\u884C\u72B6\u6001\uFF1A" }),
      /* @__PURE__ */ jsxs("span", { children: [
        statusColor && /* @__PURE__ */ jsx2(
          Badge,
          {
            status: statusColorEnum[statusColor]
          }
        ),
        /* @__PURE__ */ jsx2("span", { style: { marginLeft: "4px" }, children: statusDes })
      ] }),
      showContinueRun && /* @__PURE__ */ jsx2("span", { children: /* @__PURE__ */ jsx2(ContinueRunItem, { ...props }) })
    ] }),
    status === 0 /* success */ && outputs && /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx2("div", { style: { marginBottom: "4px" }, children: "\u6267\u884C\u7ED3\u679C\uFF1A" }),
      outputs.map((output) => /* @__PURE__ */ jsx2(
        ResultItem,
        {
          output,
          codeName,
...
var resultInfo = {
  table: { text: "\u8F93\u51FA\u8868", icon: /* @__PURE__ */ jsx2(FileTextOutlined, {}) },
  model: { text: "\u6A21\u578B", icon: /* @__PURE__ */ jsx2(ExperimentOutlined, {}) },
  rule: { text: "\u89C4\u5219", icon: /* @__PURE__ */ jsx2(ContainerOutlined, {}) },
  report: { text: "\u62A5\u544A", icon: /* @__PURE__ */ jsx2(FileSearchOutlined, {}) }
};
var ResultItem = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "resultItem", onClick: onResultClicked, children: [
    resultInfo[type]?.icon,
    resultInfo[type]?.text && /* @__PURE__ */ jsxs("span", { className: "title", children: [
      resultInfo[type].text,
      "\uFF1A"
    ] }),
    /* @__PURE__ */ jsx2(Tooltip, { title: name, children: /* @__PURE__ */ jsx2(EllipsisMiddles, { className: "elllips", maxWidth: 130, suffixCount: 3, children: name }) })
  ] });
};
var ContinueRunItem = (props) => {
  ...
  return /* @__PURE__ */ jsx2("span", { onClick: onContinueRun, className: "continueRunBtn", children: "\u7EE7\u7EED\u6267\u884C" });
};
...
var ComponentIcons = {
  default: /* @__PURE__ */ jsx3(DatabaseFilled, { style: { color: "#A1AABC" } }),
  stats: /* @__PURE__ */ jsx3(PieChartFilled, { style: { color: "#A1AABC" } }),
  preprocessing: /* @__PURE__ */ jsx3(LayoutFilled, { style: { color: "#A1AABC" } }),
  feature: /* @__PURE__ */ jsx3(LayoutFilled, { style: { color: "#A1AABC" } }),
  control: /* @__PURE__ */ jsx3(CodeFilled, { style: { color: "#A1AABC" } }),
  "ml.train": /* @__PURE__ */ jsx3(BulbFilled, { style: { color: "#A1AABC" } }),
  "ml.eval": /* @__PURE__ */ jsx3(FundFilled, { style: { color: "#A1AABC" } })
};

// src/shapes/node.tsx
import { jsx as jsx4, jsxs as jsxs2 } from "react/jsx-runtime";
var { Item: MenuItem, Divider } = Menu;
var ShowMenuContext = React.createContext(true);
var DagNode = (props) => {
  ...
  const getStatusFlag = () => {
    switch (status) {
      case 0 /* success */:
        return /* @__PURE__ */ jsx4(CheckCircleOutlined, { style: { color: "rgba(35,182,95,1)" } });
      case 2 /* failed */:
        return /* @__PURE__ */ jsx4(CloseCircleOutlined, { style: { color: "rgba(252,117,116,1)" } });
      case 5 /* stopped */:
        return /* @__PURE__ */ jsx4(PoweroffOutlined, { style: { color: "rgba(252,117,116,1)" } });
      case 1 /* running */:
        return /* @__PURE__ */ jsx4(SyncOutlined, { style: { color: "#1890FF" }, spin: true });
      case 3 /* pending */:
        return null;
      default:
        return null;
      ...
      Menu,
      {
        ...
        children: [
          /* @__PURE__ */ jsx4(
            ...
            {
              name: "copy" /* copy */,
              icon: /* @__PURE__ */ jsx4(CopyOutlined, {}),
          ...
          /* @__PURE__ */ jsx4(
            MenuItem,
            {
              ...
              icon: /* @__PURE__ */ jsx4(DeleteOutlined, {}),
          ...
          /* @__PURE__ */ jsx4(
            MenuItem,
            {
              ...
              icon: /* @__PURE__ */ jsx4(LogoutOutlined, {}),
          ...
          /* @__PURE__ */ jsx4(
            ...
            {
              name: "runUp" /* runUp */,
              icon: /* @__PURE__ */ jsx4(LoginOutlined, {}),
          ...
          /* @__PURE__ */ jsx4(
            MenuItem,
            {
              ...
              icon: /* @__PURE__ */ jsx4(PlayCircleOutlined, {}),
              hotkey: HotKeys.runSingleActionHotKey.text,
              text: "\u6267\u884C\u8282\u70B9"
            }
          ),
          data.status === 1 /* running */ && /* @__PURE__ */ jsx4(MenuItem, { name: "stopRun" /* stopRun */, icon: /* @__PURE__ */ jsx4(StopOutlined, {}), text: "\u505C\u6B62\u6267\u884C" }),
          showContinueRun && /* @__PURE__ */ jsx4(
            MenuItem,
            {
              name: "continueRun" /* continueRun */,
              icon: /* @__PURE__ */ jsx4(SyncOutlined, {}),
              text: "\u7EE7\u7EED\u6267\u884C"
            }
          )
        ]
  ...
  return showMenu ? /* @__PURE__ */ jsx4(
    Dropdown,
    {
      ...
      children: /* @__PURE__ */ jsx4(
        ...
        {
          trigger: "hover",
          content: /* @__PURE__ */ jsx4(Description, { data: { ...data, showContinueRun }, dagContext: DAGContext2 }),
          placement: "bottom",
          arrow: false,
          overlayClassName: "popover",
          overlayStyle: { width: 258 },
          destroyTooltipOnHide: true,
          children: /* @__PURE__ */ jsxs2("div", { className: classnames(["dag-node", statusName]), children: [
            /* @__PURE__ */ jsx4("span", { className: "icon", children: ComponentIcons[domain] || ComponentIcons["default"] }),
            /* @__PURE__ */ jsx4("span", { className: "label", children: label }),
            /* @__PURE__ */ jsx4("span", { className: "status", children: getStatusFlag() })
          ] })
        }
      )
    }
...
import { Graph as Graph3, Path } from "@antv/x6";
Graph3.registerConnector(
  "dag-connector",
  (s, e) => {
    const offset = 4;
...
var DAG = class {
  ...
  ActionHub = createRegistry();
  EventHub = createRegistry();
  constructor() {
